let profileListing = [
    ...
    ['Користувачі',
        'Станиці',
        'Округи',
        '<a href="/Action/GetAction">Акції</a>',
    ...
    ['Користувачі',
        ...
        'Акції/Табори',
        'Відзначення'],
    ['<a href="/Report/CreateAnnualReport">Подати річний звіт станиці</a>',
        'Таблиця користувачів',
        'Зголосити вишкіл',
        '<a href="/Report/ViewAnnualReports">Річні звіти</a>',
        'Осередки та адміни',
        'Зголошення вишколів',
        'Геостатистика',
        'Статистика по роках',
        'Статистика (періоди)',
        'Порівняти осередки',
        '<a href="/Report/CreateRaport">Додати рішення керівних органів</a>',
